...
class BrowserBuffer(QWebEngineView):
    ...
    def __init__(self, buffer_id, buffer_width, buffer_height):
        ...
        self.settings().setAttribute(QWebEnginePage.QWebEngineSettings.PluginsEnabled, True)
        self.settings().setAttribute(QWebEnginePage.QWebEngineSettings.JavascriptEnabled, True)
        self.settings().setAttribute(QWebEnginePage.QWebEngineSettings.JavascriptCanOpenWindows, True)
        self.settings().setFontFamily(QWebEnginePage.QWebEngineSettings.StandardFont, "Sans")
